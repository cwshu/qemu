...
const RISCVIsaExtData isa_edata_arr[] = {
    ...
    ISA_EXPERIMENTAL_EXT_DATA_ENTRY(smlwid, PRIV_VERSION_1_12_0, ext_smlwid),
    ISA_EXPERIMENTAL_EXT_DATA_ENTRY(smwiddeleg, PRIV_VERSION_1_12_0, ext_smwiddeleg),
    ISA_EXPERIMENTAL_EXT_DATA_ENTRY(smwid, PRIV_VERSION_1_12_0, ext_smwid),
    ISA_EXPERIMENTAL_EXT_DATA_ENTRY(smlwidlist, PRIV_VERSION_1_12_0, ext_smlwidlist),
    ...
    ISA_EXPERIMENTAL_EXT_DATA_ENTRY(sswid, PRIV_VERSION_1_12_0, ext_sswid),
...
static void riscv_cpu_reset_hold(Object *obj, ResetType type)
{
    ...
    if (riscv_cpu_cfg(env)->ext_smlwid && env->wg_reset) {
        env->wg_reset(env);
    }
