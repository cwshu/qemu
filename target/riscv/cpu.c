...
const RISCVIsaExtData isa_edata_arr[] = {
    ...
    ISA_EXT_DATA_ENTRY(smlwid, PRIV_VERSION_1_12_0, ext_smlwid),
    ISA_EXT_DATA_ENTRY(smwiddeleg, PRIV_VERSION_1_12_0, ext_smwiddeleg),
    ISA_EXT_DATA_ENTRY(smwid, PRIV_VERSION_1_12_0, ext_smwid),
    ISA_EXT_DATA_ENTRY(smlwidlist, PRIV_VERSION_1_12_0, ext_smlwidlist),
    ...
    ISA_EXT_DATA_ENTRY(sswid, PRIV_VERSION_1_12_0, ext_sswid),
