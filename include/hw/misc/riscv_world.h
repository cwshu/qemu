...
#ifndef HW_RISCV_WORLD_H
#define HW_RISCV_WORLD_H

#include "qom/object.h"
#include "hw/core/sysbus.h"
#include "exec/hwaddr.h"

#define TYPE_RISCV_WORLD "riscv.world"

#define NO_TRUSTEDWID           UINT32_MAX

typedef struct RISCVWorldState RISCVWorldState;
DECLARE_INSTANCE_CHECKER(RISCVWorldState, RISCV_WORLD,
                         TYPE_RISCV_WORLD)

struct RISCVWorldState {
    /*< private >*/
